<template>
    <section class="grid-section intro-3">
      <div class="intro-section__content">
        ...
        <nuxtLink class="prev-link icon" to="intro-2">arrow_back</nuxtLink>
        <nuxtLink class="next-link icon" to="resources">arrow_forward</nuxtLink>
      </div>
    </section>
</template>
...
.intro-3 { background-image: url('/images/intro-3.jpg'); }
