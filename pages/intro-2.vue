<template>
    ...
    <section class="grid-section intro-2">
      <div class="intro-section__content">
        ...
        <nuxtLink class="prev-link icon" to="intro-1">arrow_back</nuxtLink>
        <nuxtLink class="next-link icon" to="intro-3">arrow_forward</nuxtLink>
      </div>
    </section>
</template>
