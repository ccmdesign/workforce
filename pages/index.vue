          ...
          <div class="resources-content">
            ...
            <div class="panel">
              <stack-l>
                ...
                <p><base-button visual="primary" color="primary" @click="changeSlide('playbook')">More Information</base-button></p>
              </stack-l>
            </div>
            <div class="panel">
              <stack-l>
                ...
                <p><base-button visual="primary" color="primary" @click="changeSlide('map')">More Information</base-button></p>
              </stack-l>
            </div>
          </div>
        </div>
